...
import 'package:agora_api_project/const/agora.dart';
...
class _CamScreenState extends State<CamScreen> {
  ...
  Future<bool> init() async {
    ...
    final mircrophonePermission = resp[Permission.microphone];

    // cameraPermission 이 권한이 없다면 에러를 던지겠다.
    if (cameraPermission != PermissionStatus.granted ||
        mircrophonePermission != PermissionStatus.granted) {
